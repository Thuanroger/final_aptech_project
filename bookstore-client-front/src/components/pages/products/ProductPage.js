...
function ProductPage(props) {
  ...
  let { id, title, basePrice, description, thumbnail, dimensions, translator, format, isbn, publishedDate, discounts, availableCopies, pages, publisher, authors, categories } = data.getBook;
  const [discountedPrice, discountRate, discountAmount] = calculateDiscount(basePrice, discounts);
  discounts ={ discountedPrice: discountedPrice, discountRate:discountRate, discountAmount: discountAmount,
    __typename
    : 
    "ProcessedDiscount" }
 let dataBook =  { id, title, basePrice, description, thumbnail, dimensions, translator, format, isbn, publishedDate, discounts, availableCopies, pages, publisher, authors, categories } 
                    ...
                    <div className="book-format text-primary">
                      ...
                      <div className="box-tocart d-flex">
                        ...
                        <div className="addtocart__actions">
                          ...
                          onClick={() => addSingleItemToCart(dataBook, 1)} 
