...
function ProductItem(props) {
  let { id, thumbnail, basePrice, availableCopies, title, authors, description, reviews,
  ...
  const productDialog = (<div id="express-buy-dialog" className="express-buy-l" >
    ...
    <div className="content" id={105165} ng-show="productItem">
      ...
      <form className="ng-pristine ng-valid" onSubmit={(e) => {
        ...
        <Button onClick={() => addSingleItemToCart(props.book, 1)} loading={cart.adding} htmlType="submit" className="btn-buy btn btn-bb add-to-cart">THÊM VÀO GIỎ HÀNG</Button>
