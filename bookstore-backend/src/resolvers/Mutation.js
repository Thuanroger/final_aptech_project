...
import checkAdmin, { getUserRole } from '../utils/adminAuth.js';
import { calculateDiscount, generateOrderNumber } from '../utils/common.js';
import moment from 'moment';
import { v4 as uuidv4 } from 'uuid';
import emailTemplate from '../sendgrid/emailTemplate.js';
import QRCode from 'qrcode'
import transporter from '../sendgrid/nodeMailer.js';
...
const Mutation = {
    async signUp(parent, { data }, { prisma, env, sgMailer }, info) {
        ...
        //     sgMailer.send({
        //         from: {
        //             email: "nguyennguyenthuan231@gmail.com",
        //             name: "Bookstor"
        //         },
        //         to: data.email,
            ...
            formData.getLength((err,length)=>{
                ...
                const r = request.post(`${env.HOST_NAME_IMG}/api/image`,async (error,res,body)=>{
                    ...
                    await transporter.sendMail({
                        from: {
                            address: "nguyennguyenthuan231@gmail.com",
                            name: "bookstor"
                        },
                        ...
                        html: emailTemplate.emailReciept({
                            ...
                            logo: 'http://127.0.0.1/:4000/images/logo/logo.png',
